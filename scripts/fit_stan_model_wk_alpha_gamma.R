...
stan_model_file <- "scripts/corona_erlangEI_od_wk_model_alpha_gamma.stan"
...
make_logistic_plot(params$k2, params$x2, 0, 210, 178)

make_logistic_plot(params$k3, params$x3, 0, 310, 178)
